        ...
        private void GenerateRandom()
        {
            try
            {
                ...
                for (int i = 0; i < TotalRecords; i++)
                {
                    ...
                    var fullName = $"{(gender == "male" ? faker.Name.FirstName(Bogus.DataSets.Name.Gender.Male) : faker.Name.FirstName(Bogus.DataSets.Name.Gender.Female))} {faker.Name.LastName()}";
